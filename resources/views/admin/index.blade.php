{{--
    ...
    Admin panel: list all services with create / edit / delete / toggle controls.
--}}
...
@if($services->isEmpty())
    <div class="card">
        <div class="card-body-custom" style="text-align:center;padding:60px 20px;color:var(--grey);">
            ...
            <p style="margin:0;">No services yet. <a href="{{ route('admin.services.create') }}" style="color:var(--orange);">Create the first one</a>.</p>
        </div>
    </div>
@else
    <div class="card" style="padding:0;overflow:hidden;">
        <table style="width:100%;border-collapse:collapse;font-size:13.5px;">
            <thead>
                <tr style="background:var(--bg-soft);border-bottom:1px solid var(--grey-light);">
                    <th style="padding:12px 18px;text-align:left;font-weight:700;color:var(--grey);">Service</th>
                    <th style="padding:12px 12px;text-align:left;font-weight:700;color:var(--grey);">Price</th>
                    <th style="padding:12px 12px;text-align:center;font-weight:700;color:var(--grey);">Fields</th>
                    <th style="padding:12px 12px;text-align:center;font-weight:700;color:var(--grey);">Docs</th>
                    <th style="padding:12px 12px;text-align:center;font-weight:700;color:var(--grey);">Status</th>
                    <th style="padding:12px 18px;text-align:right;font-weight:700;color:var(--grey);">Actions</th>
                </tr>
            </thead>
            <tbody>
                            ...
                            <button type="submit"
                                ...
                                @if($service->is_active)
                                    <span style="background:#ecfdf5;color:#059669;border:1px solid #a7f3d0;
                                        ...
                                        <i class="bi bi-circle-fill" style="font-size:7px;vertical-align:1px;"></i> Active
                                    </span>
                                @else
                                    <span style="background:#fef2f2;color:#dc2626;border:1px solid #fecaca;
                                                 border-radius:20px;padding:3px 12px;font-size:12px;font-weight:600;">
                                        <i class="bi bi-circle" style="font-size:7px;vertical-align:1px;"></i> Inactive
                                    </span>
                                @endif
                            </button>
                        </form>
